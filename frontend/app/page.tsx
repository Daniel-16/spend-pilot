...
const LandingPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Calculate exactly how long your money will last based on current spending habits and income.",
    ...
    },
    {
      ...
      description: "Get actionable insights to optimize spending and accelerate your savings growth.",
    ...
    },
    {
      ...
      description: "Your data is encrypted and processed securely. We never store your financial information.",
    ...
    },
    {
      ...
      description: "Upload your statement and get comprehensive analysis in seconds, not hours.",
    ...
    },
    {
      ...
      description: "Detailed reports with specific steps you can take to improve your financial health.",
  ...
  const testimonials = [
    {
      ...
      content: "SpendPilot helped me identify $500/month in unnecessary expenses. I've saved over $6,000 this year!",
      rating: 5,
      avatar: "SJ"
    },
    {
      ...
      content: "The AI insights are incredibly accurate. It's like having a personal financial advisor in your pocket.",
      rating: 5,
      avatar: "MC"
    },
    {
      ...
      content: "The financial runway feature is a game-changer. I now have complete visibility into my financial future.",
      rating: 5,
      avatar: "ER"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 text-white overflow-hidden relative">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="px-6 py-20 bg-gradient-to-r from-indigo-900/20 to-purple-900/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 animate-fadeInUp">
              How It Works
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto animate-fadeInUp delay-200">
              Get comprehensive financial insights in three simple steps. No complex setup required.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            {[
              { step: "01", title: "Upload Statement", description: "Simply drag and drop your PDF bank statement. We support all major banks and financial institutions.", icon: Upload },
              { step: "02", title: "AI Analysis", description: "Our advanced algorithms process your transactions and identify patterns, trends, and optimization opportunities.", icon: BarChart3 },
              { step: "03", title: "Get Insights", description: "Receive personalized recommendations, runway calculations, and actionable steps to improve your financial health.", icon: TrendingUp }
            ].map((step, index) => (
      ...
      <section id="testimonials" className="px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto animate-fadeInUp delay-200">
              Join thousands of satisfied users who have transformed their financial lives with SpendPilot.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fadeInUp">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Join thousands of users who have already optimized their spending and accelerated their savings with AI-powered insights.
            </p>
      ...
      <footer className="border-t border-white/10 px-6 py-12 bg-black/20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-white/10 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 SpendPilot. All rights reserved. Built with AI-powered financial intelligence.</p>
          </div>
        </div>
      </footer>
