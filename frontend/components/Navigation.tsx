    ...
    <nav className="fixed top-2 sm:top-4 left-1/2 transform -translate-x-1/2 z-50 px-3 sm:px-4 md:px-6 py-3 sm:py-2.5 md:py-3 backdrop-blur-md bg-white/20 border border-gradient-to-r from-white/30 to-white/10 rounded-full shadow-inner shadow-black/5 w-[95%] sm:w-11/12 max-w-5xl">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 sm:gap-3">
          <div className="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 bg-blue-600 p-1.5 sm:p-2 rounded-md sm:rounded-lg shadow-sm flex items-center justify-center">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <Link
            ...
            className="bg-blue-600 text-white px-3 py-2.5 sm:px-4 sm:py-2 md:px-6 md:py-2.5 rounded-full text-xs sm:text-sm font-semibold shadow-lg hover:shadow-xl hover:from-blue-400 hover:to-indigo-400 transition-all duration-200 backdrop-blur-sm"
          >
